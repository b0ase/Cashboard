...
import type { Organization, Role, FinancialInstrument, Contract, ContractIntegration, ContractMilestone, ContractNotification, ContractAutomation, ContractsViewProps } from '@/types/dashboard'
