  ...
  const defaultTabs: CanvasTab[] = initialTabs || [{
    ...
    workflow: {
      nodes: [
        ...
        { id: 1, name: 'Music Track Streaming', type: 'youtube', x: 100, y: 100 },
        { id: 2, name: 'YouTube Ad Revenue', type: 'youtube', x: 300, y: 100 },
        { id: 3, name: 'Spotify Royalties', type: 'payment', x: 500, y: 100 },
        { id: 4, name: 'Platform Subscriptions', type: 'payment', x: 700, y: 100 },
        { id: 5, name: 'NFT Music Sales', type: 'instrument', x: 900, y: 100 },
        
        // === SECOND TIER: REVENUE AGGREGATION ===
        { id: 10, name: 'AUDEX Revenue Pool', type: 'splitter', x: 500, y: 250 },
        
        // === THIRD TIER: CORPORATE DISTRIBUTION ===
        { id: 15, name: 'AUDEX Treasury (51%)', type: 'organization', x: 300, y: 400 },
        { id: 16, name: 'Artist Royalty Pool (35%)', type: 'member', x: 500, y: 400 },
        { id: 17, name: 'Operations Reserve (10%)', type: 'workflow', x: 700, y: 400 },
        { id: 18, name: 'Platform Development (4%)', type: 'trigger', x: 900, y: 400 },
        
        // === FOURTH TIER: TOKEN MANAGEMENT ===
        { id: 20, name: 'AUDEX Token Contract', type: 'contract', x: 500, y: 550 },
        
        // === FIFTH TIER: DIVIDEND CALCULATION ===
        { id: 30, name: 'Quarterly Dividend Calculator', type: 'decision', x: 500, y: 700 },
        
        // === BOTTOM TIER: SHAREHOLDER DISTRIBUTION (PYRAMID TOP) ===
        { id: 21, name: 'Treasury Tokens (51%)', type: 'wallets', x: 200, y: 850 },
        { id: 22, name: 'Public Shareholders (35%)', type: 'member', x: 400, y: 850 },
        { id: 23, name: 'Artist Token Holders (10%)', type: 'member', x: 600, y: 850 },
        { id: 24, name: 'Team & Advisors (4%)', type: 'role', x: 800, y: 850 },
        
        // === SIDE BRANCH: INDIVIDUAL TRACK ASSETS ===
        { id: 40, name: 'Track NFT #001', type: 'instrument', x: 1100, y: 250 },
        { id: 41, name: 'Track Royalty Split', type: 'splitter', x: 1100, y: 400 },
        { id: 42, name: 'Track Shareholders', type: 'member', x: 1100, y: 550 },
        
        // === SIDE BRANCH: PLATFORM ASSETS ===
        { id: 50, name: 'AUDEX Platform IP', type: 'contract', x: 100, y: 550 },
        { id: 51, name: 'User Database', type: 'workflow', x: 100, y: 700 },
        { id: 52, name: 'Music Catalog Rights', type: 'instrument', x: 100, y: 850 }
      ],
      connections: [
