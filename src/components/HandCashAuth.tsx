  ...
  return (
    <div className="w-full space-y-3">
      ...
      <button
        ...
        className="w-full bg-white hover:bg-gray-100 text-gray-800 px-3 py-2 rounded-lg transition-all duration-200 hover:scale-[1.02] flex items-center justify-center space-x-2 shadow-lg border border-gray-200"
      >
